...
*-------------use method------------------
*jsDate.date(format)=====>return: {String} formatted date result of current time.
*jsDate.date(format, dateTime)====>return: {String} formatted date result of dateTime
*jsDate.date(format, dateTimeOffset);====>return: {String} formatted date result plus with dateTimeOffset
*jsDate.date(format, dateTimeOffset, dateTime);===>return: {String} formatted date result of dateTime plus with dateTimeOffset
*jsDate.date(dateTimeOffset)===>return: {Date Object} date object of current time plus with dateTimeOffset.
*jsDate.date(dateTimeOffset, dateTime)===>return: {Date Object} date object of dateTime plus with dateTimeOffset.
*jsDate.date(dateTime)====>return: {Date Object} date object of dateTime.
*jsDate.date()===>return: {Date Object} date object of current time
*/
jsDate.date=function(format, dateTimeOffset, dateTime){
